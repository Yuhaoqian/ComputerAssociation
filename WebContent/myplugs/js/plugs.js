...
$.extend({
        ...
        jq_Panel: function (e) {
            ...
            var str = "<div class='jq_dvpanel'  style='z-index:2;box-shadow: 0px 0px 5px #BCD4E5;border: 1px solid #BCD4E5 !important;position:absolute;background-Color:#fff;width:"
                ...
                + e.title
                + "</div>"
                + "<button title='关闭' id='btnclosepanel' style='outline:0px;float:right;margin-top:6px;margin-right:5px;font-size:18px;font-weight: bold;color: rgb(0, 0, 0);text-shadow: 0px 1px 0px rgb(255, 255, 255);border:0px;background-color:transparent;cursor:pointer;opacity:0.2;filter:alpha(opacity=20);-moz-opacity:0.2;'>×</button>"
                + "</div>"
        ...
        chkAll: function (options) {
            ...
            // 全选的复选框
            $('.am-form').on('click','#chkAll',function () {
            	let chks = $("."+opt.chkName);
                chks.prop("checked", $('#chkAll').is(":checked"));
            });
            $('.am-form').on('click','.chks',function () {
            	let chks = $("."+opt.chkName);
            	$('#chkAll').prop("checked", chks.length == chks
                    ...
                    $
                        .ajax({
                            ...
                            success: function (d) {
                                ...
                                let idx=0;
                                for (var i in o) {
                                	if(idx>=(e.currentPage-1)*e.pageSize&&idx<e.currentPage*e.pageSize)
                                	obj[i]=o[i];
                                	idx++;
                                }
                                pageCount = parseInt(d.pagecount);
                                var str = "<table class='am-table am-table-striped am-table-hover table-main' id='"
                                    + e.tableId
                                    + "'>"
                                    + "<thead>"
                                    + "<tr>"
                                ...
                                str += "<tfoot style='background-color:#f9f9f9;'>"
                                    ...
                                    + "<div class='dvpagerecord pagefirst'>"
                                    + "<i class='icon-double-angle-left'>首页</i>"
                                    + "</div>"
                                    + "<div class='dvpagerecord prvePage'>"
                                    + "<i class='icon-angle-left'>上一页</i>"
                                    + "</div>"
                                ...
                                str += pp;
                                str += "</ul>"
                                    + "<div class='dvpagerecord nextPage'>"
                                    + "<i class='icon-angle-right'>下一页</i>"
                                    + "</div>"
                                    + "<div class='dvpagerecord pagelast'>"
                                    + "<i class='icon-double-angle-right'>尾页</i>"
                                    + "</div>" + "</div></td>"
                                    + "</tr>" + "</tfoot>"
                                    + "</table>";
                                $.pageObject.html(str);
